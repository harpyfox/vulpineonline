...
type BodyInit = ReadableStream[Uint8Array[ArrayBufferLike]] | str | ArrayBuffer | ArrayBufferView_iface[ArrayBufferLike] | Blob | URLSearchParams | FormData
...
type Ai_Cf_Baai_Bge_Base_En_V1_5_Output = Ai_Cf_Baai_Bge_Base_En_V1_5_Output__Union0 | AsyncResponse_iface
...
type Ai_Cf_Meta_M2M100_1_2B_Output = Ai_Cf_Meta_M2M100_1_2B_Output__Union0 | AsyncResponse_iface
...
type Ai_Cf_Baai_Bge_Small_En_V1_5_Output = Ai_Cf_Baai_Bge_Small_En_V1_5_Output__Union0 | AsyncResponse_iface
...
type Ai_Cf_Baai_Bge_Large_En_V1_5_Output = Ai_Cf_Baai_Bge_Large_En_V1_5_Output__Union0 | AsyncResponse_iface
...
type Ai_Cf_Baai_Bge_M3_Input = BGEM3InputQueryAndContexts_iface | BGEM3InputEmbedding_iface | Ai_Cf_Baai_Bge_M3_Input__Union2

type Ai_Cf_Baai_Bge_M3_Output = BGEM3OuputQuery_iface | BGEM3OutputEmbeddingForContexts_iface | BGEM3OuputEmbedding_iface | AsyncResponse_iface

type Ai_Cf_Meta_Llama_3_2_11B_Vision_Instruct_Input = Prompt_iface | Messages_iface

type Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Input = Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Prompt_iface | Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface | AsyncBatch_iface

type Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Output = Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Output__Union0 | str | AsyncResponse_iface

type Ai_Cf_Qwen_Qwen2_5_Coder_32B_Instruct_Input = Qwen2_5_Coder_32B_Instruct_Prompt_iface | Qwen2_5_Coder_32B_Instruct_Messages_iface

type Ai_Cf_Qwen_Qwq_32B_Input = Qwen_Qwq_32B_Prompt_iface | Qwen_Qwq_32B_Messages_iface

type Ai_Cf_Mistralai_Mistral_Small_3_1_24B_Instruct_Input = Mistral_Small_3_1_24B_Instruct_Prompt_iface | Mistral_Small_3_1_24B_Instruct_Messages_iface

type Ai_Cf_Google_Gemma_3_12B_It_Input = Google_Gemma_3_12B_It_Prompt_iface | Google_Gemma_3_12B_It_Messages_iface

type Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Input = Ai_Cf_Meta_Llama_4_Prompt_iface | Ai_Cf_Meta_Llama_4_Messages_iface | Ai_Cf_Meta_Llama_4_Async_Batch_iface
...
type Ai_Cf_Openai_Gpt_Oss_120B_Input = GPT_OSS_120B_Responses_iface | GPT_OSS_120B_Responses_Async_iface

type Ai_Cf_Openai_Gpt_Oss_120B_Output = Ai_Cf_Openai_Gpt_Oss_120B_Output__Union0 | (Ai_Cf_Openai_Gpt_Oss_120B_Output__Union1)

type Ai_Cf_Openai_Gpt_Oss_20B_Input = GPT_OSS_20B_Responses_iface | GPT_OSS_20B_Responses_Async_iface

type Ai_Cf_Openai_Gpt_Oss_20B_Output = Ai_Cf_Openai_Gpt_Oss_20B_Output__Union0 | (Ai_Cf_Openai_Gpt_Oss_20B_Output__Union1)
...
class Env(Protocol): # type:ignore[misc, unused-ignore]
    KV: KVNamespace_iface = ... # type:ignore[assignment,unused-ignore]
    REFERERS: AnalyticsEngineDataset_iface = ... # type:ignore[assignment,unused-ignore]
    CF_VERSION_METADATA: WorkerVersionMetadata = ... # type:ignore[assignment,unused-ignore]
...
class Navigator_iface(Protocol): # type:ignore[misc, unused-ignore]
    ...
    def sendBeacon(self, url: str, body: (ReadableStream[Any] | str | (ArrayBuffer | ArrayBufferView_iface[ArrayBufferLike]) | Blob | FormData | URLSearchParams | URLSearchParams) | None = None, /) -> bool: ... # type:ignore[misc,overload-overlap,override,unused-ignore]
...
class Base_Ai_Cf_Openai_Gpt_Oss_120B_iface(Protocol): # type:ignore[misc, unused-ignore]
    inputs: Ai_Cf_Openai_Gpt_Oss_120B_Input = ... # type:ignore[assignment,unused-ignore]
    postProcessedOutputs: Ai_Cf_Openai_Gpt_Oss_120B_Output = ... # type:ignore[assignment,unused-ignore]
...
class Base_Ai_Cf_Openai_Gpt_Oss_20B_iface(Protocol): # type:ignore[misc, unused-ignore]
    inputs: Ai_Cf_Openai_Gpt_Oss_20B_Input = ... # type:ignore[assignment,unused-ignore]
    postProcessedOutputs: Ai_Cf_Openai_Gpt_Oss_20B_Output = ... # type:ignore[assignment,unused-ignore]
...
class Ai_iface[AiModelList=AiModels_iface](Protocol): # type:ignore[misc, unused-ignore]
    ...
    @overload
    def toMarkdown(self, files: PyMutableSequence[Ai__toMarkdown__Sig1__files__array], /, *, gateway: GatewayOptions | None = None, extraHeaders: Any | None = None) -> Future[JsArray[ConversionResponse]]: ... # type:ignore[misc,overload-overlap,override,unused-ignore]
    @overload
    def toMarkdown(self, files: Ai__toMarkdown__Sig2__files, /, *, gateway: GatewayOptions | None = None, extraHeaders: Any | None = None) -> Future[ConversionResponse]: ... # type:ignore[misc,overload-overlap,override,unused-ignore]
...
class ToMarkdownService_iface(Protocol): # type:ignore[misc, unused-ignore]
    @overload
    def transform(self, files: PyMutableSequence[ToMarkdownService__transform__Sig0__files__array], /, *, gateway: GatewayOptions | None = None, extraHeaders: Any | None = None) -> Future[JsArray[ConversionResponse]]: ... # type:ignore[misc,overload-overlap,override,unused-ignore]
    @overload
    def transform(self, files: ToMarkdownService__transform__Sig1__files, /, *, gateway: GatewayOptions | None = None, extraHeaders: Any | None = None) -> Future[ConversionResponse]: ... # type:ignore[misc,overload-overlap,override,unused-ignore]
...
class AnalyticsEngineDataset_iface(Protocol): # type:ignore[misc, unused-ignore]
    @overload
    def writeDataPoint(self, event: AnalyticsEngineDataPoint_iface | None = None, /) -> None: ... # type:ignore[misc,overload-overlap,override,unused-ignore]
    @overload
    def writeDataPoint(self, /, *, indexes: PyMutableSequence[((ArrayBuffer | str) | None)] | None = None, doubles: PyMutableSequence[int | float] | None = None, blobs: PyMutableSequence[((ArrayBuffer | str) | None)] | None = None) -> None: ... # type:ignore[misc,overload-overlap,override,unused-ignore]
...
class AnalyticsEngineDataPoint_iface(Protocol): # type:ignore[misc, unused-ignore]
    indexes: JsArray[((ArrayBuffer | str) | None)] | None = ... # type:ignore[assignment,unused-ignore]
    doubles: JsArray[int | float] | None = ... # type:ignore[assignment,unused-ignore]
    blobs: JsArray[((ArrayBuffer | str) | None)] | None = ... # type:ignore[assignment,unused-ignore]
...
class AsyncResponse_iface(Protocol): # type:ignore[misc, unused-ignore]
    request_id: str | None = ... # type:ignore[assignment,unused-ignore]

class BGEM3InputQueryAndContexts_iface(Protocol): # type:ignore[misc, unused-ignore]
    query: str | None = ... # type:ignore[assignment,unused-ignore]
    contexts: JsArray[BGEM3InputQueryAndContexts_iface__contexts__array] = ... # type:ignore[assignment,unused-ignore]
    truncate_inputs: bool | None = ... # type:ignore[assignment,unused-ignore]

class BGEM3InputEmbedding_iface(Protocol): # type:ignore[misc, unused-ignore]
    text: str | JsArray[str] = ... # type:ignore[assignment,unused-ignore]
    truncate_inputs: bool | None = ... # type:ignore[assignment,unused-ignore]

class BGEM3InputQueryAndContexts1_iface(Protocol): # type:ignore[misc, unused-ignore]
    query: str | None = ... # type:ignore[assignment,unused-ignore]
    contexts: JsArray[BGEM3InputQueryAndContexts1_iface__contexts__array] = ... # type:ignore[assignment,unused-ignore]
    truncate_inputs: bool | None = ... # type:ignore[assignment,unused-ignore]

class BGEM3InputEmbedding1_iface(Protocol): # type:ignore[misc, unused-ignore]
    text: str | JsArray[str] = ... # type:ignore[assignment,unused-ignore]
    truncate_inputs: bool | None = ... # type:ignore[assignment,unused-ignore]

class BGEM3OuputQuery_iface(Protocol): # type:ignore[misc, unused-ignore]
    response: JsArray[BGEM3OuputQuery_iface__response__array] | None = ... # type:ignore[assignment,unused-ignore]

class BGEM3OutputEmbeddingForContexts_iface(Protocol): # type:ignore[misc, unused-ignore]
...
class BGEM3OuputEmbedding_iface(Protocol): # type:ignore[misc, unused-ignore]
    shape: JsArray[int | float] | None = ... # type:ignore[assignment,unused-ignore]
    data: JsArray[JsArray[int | float]] | None = ... # type:ignore[assignment,unused-ignore]
    pooling: Literal["mean", "cls"] | None = ... # type:ignore[assignment,unused-ignore]

class Prompt_iface(Protocol): # type:ignore[misc, unused-ignore]
    prompt: str = ... # type:ignore[assignment,unused-ignore]
    image: JsArray[int | float] | (Prompt_iface__image__Union1) | None = ... # type:ignore[assignment,unused-ignore]
...
class Messages_iface(Protocol): # type:ignore[misc, unused-ignore]
    messages: JsArray[Messages_iface__messages__array] = ... # type:ignore[assignment,unused-ignore]
    image: JsArray[int | float] | (Messages_iface__image__Union1) | None = ... # type:ignore[assignment,unused-ignore]
    functions: JsArray[Messages_iface__functions__array] | None = ... # type:ignore[assignment,unused-ignore]
    tools: JsArray[(Messages_iface__tools__array__Union0 | Messages_iface__tools__array__Union1)] | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
    max_tokens: int | float | None = ... # type:ignore[assignment,unused-ignore]
    temperature: int | float | None = ... # type:ignore[assignment,unused-ignore]
    top_p: int | float | None = ... # type:ignore[assignment,unused-ignore]
...
class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Prompt_iface(Protocol): # type:ignore[misc, unused-ignore]
    prompt: str = ... # type:ignore[assignment,unused-ignore]
    lora: str | None = ... # type:ignore[assignment,unused-ignore]
    response_format: JSONMode_iface | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
    max_tokens: int | float | None = ... # type:ignore[assignment,unused-ignore]
    temperature: int | float | None = ... # type:ignore[assignment,unused-ignore]
...
class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface(Protocol): # type:ignore[misc, unused-ignore]
    messages: JsArray[Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__messages__array] = ... # type:ignore[assignment,unused-ignore]
    functions: JsArray[Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__functions__array] | None = ... # type:ignore[assignment,unused-ignore]
    tools: JsArray[(Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union0 | Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union1)] | None = ... # type:ignore[assignment,unused-ignore]
    response_format: JSONMode_iface | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
    max_tokens: int | float | None = ... # type:ignore[assignment,unused-ignore]
...
class AsyncBatch_iface(Protocol): # type:ignore[misc, unused-ignore]
    requests: JsArray[AsyncBatch_iface__requests__array] | None = ... # type:ignore[assignment,unused-ignore]

class Qwen2_5_Coder_32B_Instruct_Prompt_iface(Protocol): # type:ignore[misc, unused-ignore]
    prompt: str = ... # type:ignore[assignment,unused-ignore]
    lora: str | None = ... # type:ignore[assignment,unused-ignore]
    response_format: JSONMode_iface | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
...
class Qwen2_5_Coder_32B_Instruct_Messages_iface(Protocol): # type:ignore[misc, unused-ignore]
    messages: JsArray[Qwen2_5_Coder_32B_Instruct_Messages_iface__messages__array] = ... # type:ignore[assignment,unused-ignore]
    functions: JsArray[Qwen2_5_Coder_32B_Instruct_Messages_iface__functions__array] | None = ... # type:ignore[assignment,unused-ignore]
    tools: JsArray[(Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union0 | Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union1)] | None = ... # type:ignore[assignment,unused-ignore]
    response_format: JSONMode_iface | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
    max_tokens: int | float | None = ... # type:ignore[assignment,unused-ignore]
...
class Qwen_Qwq_32B_Prompt_iface(Protocol): # type:ignore[misc, unused-ignore]
    prompt: str = ... # type:ignore[assignment,unused-ignore]
...
class Qwen_Qwq_32B_Messages_iface(Protocol): # type:ignore[misc, unused-ignore]
    messages: JsArray[Qwen_Qwq_32B_Messages_iface__messages__array] = ... # type:ignore[assignment,unused-ignore]
    functions: JsArray[Qwen_Qwq_32B_Messages_iface__functions__array] | None = ... # type:ignore[assignment,unused-ignore]
    tools: JsArray[(Qwen_Qwq_32B_Messages_iface__tools__array__Union0 | Qwen_Qwq_32B_Messages_iface__tools__array__Union1)] | None = ... # type:ignore[assignment,unused-ignore]
    guided_json: Any | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
    max_tokens: int | float | None = ... # type:ignore[assignment,unused-ignore]
...
class Mistral_Small_3_1_24B_Instruct_Prompt_iface(Protocol): # type:ignore[misc, unused-ignore]
    prompt: str = ... # type:ignore[assignment,unused-ignore]
    guided_json: Any | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
...
class Mistral_Small_3_1_24B_Instruct_Messages_iface(Protocol): # type:ignore[misc, unused-ignore]
    messages: JsArray[Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array] = ... # type:ignore[assignment,unused-ignore]
    functions: JsArray[Mistral_Small_3_1_24B_Instruct_Messages_iface__functions__array] | None = ... # type:ignore[assignment,unused-ignore]
    tools: JsArray[(Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union0 | Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union1)] | None = ... # type:ignore[assignment,unused-ignore]
    guided_json: Any | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
    max_tokens: int | float | None = ... # type:ignore[assignment,unused-ignore]
...
class Google_Gemma_3_12B_It_Prompt_iface(Protocol): # type:ignore[misc, unused-ignore]
    prompt: str = ... # type:ignore[assignment,unused-ignore]
    guided_json: Any | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
...
class Google_Gemma_3_12B_It_Messages_iface(Protocol): # type:ignore[misc, unused-ignore]
    messages: JsArray[Google_Gemma_3_12B_It_Messages_iface__messages__array] = ... # type:ignore[assignment,unused-ignore]
    functions: JsArray[Google_Gemma_3_12B_It_Messages_iface__functions__array] | None = ... # type:ignore[assignment,unused-ignore]
    tools: JsArray[(Google_Gemma_3_12B_It_Messages_iface__tools__array__Union0 | Google_Gemma_3_12B_It_Messages_iface__tools__array__Union1)] | None = ... # type:ignore[assignment,unused-ignore]
    guided_json: Any | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
    max_tokens: int | float | None = ... # type:ignore[assignment,unused-ignore]
...
class Ai_Cf_Meta_Llama_4_Prompt_iface(Protocol): # type:ignore[misc, unused-ignore]
    prompt: str = ... # type:ignore[assignment,unused-ignore]
    guided_json: Any | None = ... # type:ignore[assignment,unused-ignore]
    response_format: JSONMode_iface | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
...
class Ai_Cf_Meta_Llama_4_Messages_iface(Protocol): # type:ignore[misc, unused-ignore]
    messages: JsArray[Ai_Cf_Meta_Llama_4_Messages_iface__messages__array] = ... # type:ignore[assignment,unused-ignore]
    functions: JsArray[Ai_Cf_Meta_Llama_4_Messages_iface__functions__array] | None = ... # type:ignore[assignment,unused-ignore]
    tools: JsArray[(Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union0 | Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union1)] | None = ... # type:ignore[assignment,unused-ignore]
    response_format: JSONMode_iface | None = ... # type:ignore[assignment,unused-ignore]
    guided_json: Any | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
...
class Ai_Cf_Meta_Llama_4_Async_Batch_iface(Protocol): # type:ignore[misc, unused-ignore]
    requests: JsArray[(Ai_Cf_Meta_Llama_4_Prompt_Inner_iface | Ai_Cf_Meta_Llama_4_Messages_Inner_iface)] = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_120B_Responses_iface(Protocol): # type:ignore[misc, unused-ignore]
    input: str | JsArray[Any] = ... # type:ignore[assignment,unused-ignore]
    reasoning: GPT_OSS_120B_Responses_iface__reasoning | None = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_120B_Responses_Async_iface(Protocol): # type:ignore[misc, unused-ignore]
    requests: JsArray[GPT_OSS_120B_Responses_Async_iface__requests__array] = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_20B_Responses_iface(Protocol): # type:ignore[misc, unused-ignore]
    input: str | JsArray[Any] = ... # type:ignore[assignment,unused-ignore]
    reasoning: GPT_OSS_20B_Responses_iface__reasoning | None = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_20B_Responses_Async_iface(Protocol): # type:ignore[misc, unused-ignore]
    requests: JsArray[GPT_OSS_20B_Responses_Async_iface__requests__array] = ... # type:ignore[assignment,unused-ignore]
...
class JSONMode_iface(Protocol): # type:ignore[misc, unused-ignore]
...
class Ai_Cf_Meta_Llama_4_Prompt_Inner_iface(Protocol): # type:ignore[misc, unused-ignore]
    prompt: str = ... # type:ignore[assignment,unused-ignore]
    guided_json: Any | None = ... # type:ignore[assignment,unused-ignore]
    response_format: JSONMode_iface | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
...
class Ai_Cf_Meta_Llama_4_Messages_Inner_iface(Protocol): # type:ignore[misc, unused-ignore]
    messages: JsArray[Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array] = ... # type:ignore[assignment,unused-ignore]
    functions: JsArray[Ai_Cf_Meta_Llama_4_Messages_Inner_iface__functions__array] | None = ... # type:ignore[assignment,unused-ignore]
    tools: JsArray[(Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union0 | Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union1)] | None = ... # type:ignore[assignment,unused-ignore]
    response_format: JSONMode_iface | None = ... # type:ignore[assignment,unused-ignore]
    guided_json: Any | None = ... # type:ignore[assignment,unused-ignore]
    raw: bool | None = ... # type:ignore[assignment,unused-ignore]
    stream: bool | None = ... # type:ignore[assignment,unused-ignore]
...
class Ai__toMarkdown__Sig1__files__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    blob: Blob = ... # type:ignore[assignment,unused-ignore]

class Ai__toMarkdown__Sig2__files(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    blob: Blob = ... # type:ignore[assignment,unused-ignore]

class ToMarkdownService__transform__Sig0__files__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    blob: Blob = ... # type:ignore[assignment,unused-ignore]

class ToMarkdownService__transform__Sig1__files(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    blob: Blob = ... # type:ignore[assignment,unused-ignore]
...
class WorkerVersionMetadata(Protocol): # type:ignore[misc, unused-ignore]
    id: str = ... # type:ignore[assignment,unused-ignore]
    tag: str = ... # type:ignore[assignment,unused-ignore]
...
class Ai_Cf_Baai_Bge_M3_Input__Union2(Protocol): # type:ignore[misc, unused-ignore]
    requests: JsArray[(BGEM3InputQueryAndContexts1_iface | BGEM3InputEmbedding1_iface)] = ... # type:ignore[assignment,unused-ignore]
...
class Ai_Cf_Openai_Gpt_Oss_120B_Output__Union0(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Ai_Cf_Openai_Gpt_Oss_120B_Output__Union1(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Ai_Cf_Openai_Gpt_Oss_20B_Output__Union0(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Ai_Cf_Openai_Gpt_Oss_20B_Output__Union1(Protocol): # type:ignore[misc, unused-ignore]
    pass
...
class ConversionResponse__Intersection0(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    mimeType: str = ... # type:ignore[assignment,unused-ignore]

class ConversionResponse__Intersection1__Union0(Protocol): # type:ignore[misc, unused-ignore]
...
class ConversionResponse__Intersection1__Union1(Protocol): # type:ignore[misc, unused-ignore]
    format: Literal["error"] = ... # type:ignore[assignment,unused-ignore]
    error: str = ... # type:ignore[assignment,unused-ignore]

class ConversionResponse(ConversionResponse__Intersection0, Protocol): # type:ignore[misc, unused-ignore]
    pass
...
class BGEM3InputQueryAndContexts_iface__contexts__array(Protocol): # type:ignore[misc, unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]

class BGEM3InputQueryAndContexts1_iface__contexts__array(Protocol): # type:ignore[misc, unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]

class BGEM3OuputQuery_iface__response__array(Protocol): # type:ignore[misc, unused-ignore]
    id: int | float | None = ... # type:ignore[assignment,unused-ignore]
    score: int | float | None = ... # type:ignore[assignment,unused-ignore]

class Prompt_iface__image__Union1(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Messages_iface__messages__array__content__Union1__array__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__messages__array__content__Union1__array(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Messages_iface__messages__array__content__Union1__array__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__messages__array__content__Union2__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__messages__array__content__Union2(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Messages_iface__messages__array__content__Union2__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__messages__array(Protocol): # type:ignore[misc, unused-ignore]
    role: str | None = ... # type:ignore[assignment,unused-ignore]
    tool_call_id: str | None = ... # type:ignore[assignment,unused-ignore]
    content: str | JsArray[Messages_iface__messages__array__content__Union1__array] | Messages_iface__messages__array__content__Union2 | None = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__image__Union1(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Messages_iface__functions__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    code: str = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__tools__array__Union0__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Messages_iface__tools__array__Union0__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Messages_iface__tools__array__Union0__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__tools__array__Union0(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Messages_iface__tools__array__Union0__parameters = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__tools__array__Union1__function__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Messages_iface__tools__array__Union1__function__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Messages_iface__tools__array__Union1__function__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__tools__array__Union1__function(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Messages_iface__tools__array__Union1__function__parameters = ... # type:ignore[assignment,unused-ignore]

class Messages_iface__tools__array__Union1(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    function: Messages_iface__tools__array__Union1__function = ... # type:ignore[assignment,unused-ignore]

class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__messages__array(Protocol): # type:ignore[misc, unused-ignore]
    role: str = ... # type:ignore[assignment,unused-ignore]
    content: str = ... # type:ignore[assignment,unused-ignore]

class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__functions__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    code: str = ... # type:ignore[assignment,unused-ignore]

class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union0__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union0__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union0__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union0(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union0__parameters = ... # type:ignore[assignment,unused-ignore]

class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union1__function__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union1__function__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union1__function__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union1__function(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union1__function__parameters = ... # type:ignore[assignment,unused-ignore]

class Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union1(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    function: Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages_iface__tools__array__Union1__function = ... # type:ignore[assignment,unused-ignore]

class AsyncBatch_iface__requests__array(Protocol): # type:ignore[misc, unused-ignore]
...
class Qwen2_5_Coder_32B_Instruct_Messages_iface__messages__array(Protocol): # type:ignore[misc, unused-ignore]
    role: str = ... # type:ignore[assignment,unused-ignore]
    content: str = ... # type:ignore[assignment,unused-ignore]

class Qwen2_5_Coder_32B_Instruct_Messages_iface__functions__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    code: str = ... # type:ignore[assignment,unused-ignore]

class Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union0__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union0__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union0__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union0(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union0__parameters = ... # type:ignore[assignment,unused-ignore]

class Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union1__function__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union1__function__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union1__function__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union1__function(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union1__function__parameters = ... # type:ignore[assignment,unused-ignore]

class Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union1(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    function: Qwen2_5_Coder_32B_Instruct_Messages_iface__tools__array__Union1__function = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__messages__array__content__Union1__array__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__messages__array__content__Union1__array(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Qwen_Qwq_32B_Messages_iface__messages__array__content__Union1__array__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__messages__array__content__Union2__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__messages__array__content__Union2(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Qwen_Qwq_32B_Messages_iface__messages__array__content__Union2__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__messages__array(Protocol): # type:ignore[misc, unused-ignore]
    role: str | None = ... # type:ignore[assignment,unused-ignore]
    tool_call_id: str | None = ... # type:ignore[assignment,unused-ignore]
    content: str | JsArray[Qwen_Qwq_32B_Messages_iface__messages__array__content__Union1__array] | Qwen_Qwq_32B_Messages_iface__messages__array__content__Union2 | None = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__functions__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    code: str = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__tools__array__Union0__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Qwen_Qwq_32B_Messages_iface__tools__array__Union0__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Qwen_Qwq_32B_Messages_iface__tools__array__Union0__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__tools__array__Union0(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Qwen_Qwq_32B_Messages_iface__tools__array__Union0__parameters = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__tools__array__Union1__function__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Qwen_Qwq_32B_Messages_iface__tools__array__Union1__function__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Qwen_Qwq_32B_Messages_iface__tools__array__Union1__function__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__tools__array__Union1__function(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Qwen_Qwq_32B_Messages_iface__tools__array__Union1__function__parameters = ... # type:ignore[assignment,unused-ignore]

class Qwen_Qwq_32B_Messages_iface__tools__array__Union1(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    function: Qwen_Qwq_32B_Messages_iface__tools__array__Union1__function = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array__content__Union1__array__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array__content__Union1__array(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array__content__Union1__array__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array__content__Union2__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array__content__Union2(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array__content__Union2__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array(Protocol): # type:ignore[misc, unused-ignore]
    role: str | None = ... # type:ignore[assignment,unused-ignore]
    tool_call_id: str | None = ... # type:ignore[assignment,unused-ignore]
    content: str | JsArray[Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array__content__Union1__array] | Mistral_Small_3_1_24B_Instruct_Messages_iface__messages__array__content__Union2 | None = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__functions__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    code: str = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union0__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union0__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union0__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union0(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union0__parameters = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union1__function__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union1__function__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union1__function__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union1__function(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union1__function__parameters = ... # type:ignore[assignment,unused-ignore]

class Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union1(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    function: Mistral_Small_3_1_24B_Instruct_Messages_iface__tools__array__Union1__function = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__messages__array__content__Union1__array__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__messages__array__content__Union1__array(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Google_Gemma_3_12B_It_Messages_iface__messages__array__content__Union1__array__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__messages__array__content__Union2__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__messages__array__content__Union2(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Google_Gemma_3_12B_It_Messages_iface__messages__array__content__Union2__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__messages__array(Protocol): # type:ignore[misc, unused-ignore]
    role: str | None = ... # type:ignore[assignment,unused-ignore]
    content: str | JsArray[Google_Gemma_3_12B_It_Messages_iface__messages__array__content__Union1__array] | Google_Gemma_3_12B_It_Messages_iface__messages__array__content__Union2 | None = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__functions__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    code: str = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__tools__array__Union0__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Google_Gemma_3_12B_It_Messages_iface__tools__array__Union0__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Google_Gemma_3_12B_It_Messages_iface__tools__array__Union0__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__tools__array__Union0(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Google_Gemma_3_12B_It_Messages_iface__tools__array__Union0__parameters = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__tools__array__Union1__function__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Google_Gemma_3_12B_It_Messages_iface__tools__array__Union1__function__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Google_Gemma_3_12B_It_Messages_iface__tools__array__Union1__function__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__tools__array__Union1__function(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Google_Gemma_3_12B_It_Messages_iface__tools__array__Union1__function__parameters = ... # type:ignore[assignment,unused-ignore]

class Google_Gemma_3_12B_It_Messages_iface__tools__array__Union1(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    function: Google_Gemma_3_12B_It_Messages_iface__tools__array__Union1__function = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__messages__array__content__Union1__array__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__messages__array__content__Union1__array(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Ai_Cf_Meta_Llama_4_Messages_iface__messages__array__content__Union1__array__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__messages__array__content__Union2__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__messages__array__content__Union2(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Ai_Cf_Meta_Llama_4_Messages_iface__messages__array__content__Union2__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__messages__array(Protocol): # type:ignore[misc, unused-ignore]
    role: str | None = ... # type:ignore[assignment,unused-ignore]
    tool_call_id: str | None = ... # type:ignore[assignment,unused-ignore]
    content: str | JsArray[Ai_Cf_Meta_Llama_4_Messages_iface__messages__array__content__Union1__array] | Ai_Cf_Meta_Llama_4_Messages_iface__messages__array__content__Union2 | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__functions__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    code: str = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union0__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union0__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union0__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union0(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union0__parameters = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union1__function__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union1__function__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union1__function__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union1__function(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union1__function__parameters = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union1(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    function: Ai_Cf_Meta_Llama_4_Messages_iface__tools__array__Union1__function = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_120B_Responses_iface__reasoning(Protocol): # type:ignore[misc, unused-ignore]
    effort: Literal["low", "medium", "high"] | None = ... # type:ignore[assignment,unused-ignore]
    summary: Literal["auto", "concise", "detailed"] | None = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_120B_Responses_Async_iface__requests__array__reasoning(Protocol): # type:ignore[misc, unused-ignore]
    effort: Literal["low", "medium", "high"] | None = ... # type:ignore[assignment,unused-ignore]
    summary: Literal["auto", "concise", "detailed"] | None = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_120B_Responses_Async_iface__requests__array(Protocol): # type:ignore[misc, unused-ignore]
    input: str | JsArray[Any] = ... # type:ignore[assignment,unused-ignore]
    reasoning: GPT_OSS_120B_Responses_Async_iface__requests__array__reasoning | None = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_20B_Responses_iface__reasoning(Protocol): # type:ignore[misc, unused-ignore]
    effort: Literal["low", "medium", "high"] | None = ... # type:ignore[assignment,unused-ignore]
    summary: Literal["auto", "concise", "detailed"] | None = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_20B_Responses_Async_iface__requests__array__reasoning(Protocol): # type:ignore[misc, unused-ignore]
    effort: Literal["low", "medium", "high"] | None = ... # type:ignore[assignment,unused-ignore]
    summary: Literal["auto", "concise", "detailed"] | None = ... # type:ignore[assignment,unused-ignore]

class GPT_OSS_20B_Responses_Async_iface__requests__array(Protocol): # type:ignore[misc, unused-ignore]
    input: str | JsArray[Any] = ... # type:ignore[assignment,unused-ignore]
    reasoning: GPT_OSS_20B_Responses_Async_iface__requests__array__reasoning | None = ... # type:ignore[assignment,unused-ignore]
...
class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array__content__Union1__array__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array__content__Union1__array(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array__content__Union1__array__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array__content__Union2__image_url(Protocol): # type:ignore[misc, unused-ignore]
    url: str | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array__content__Union2(Protocol): # type:ignore[misc, unused-ignore]
    type: str | None = ... # type:ignore[assignment,unused-ignore]
    text: str | None = ... # type:ignore[assignment,unused-ignore]
    image_url: Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array__content__Union2__image_url | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array(Protocol): # type:ignore[misc, unused-ignore]
    role: str | None = ... # type:ignore[assignment,unused-ignore]
    tool_call_id: str | None = ... # type:ignore[assignment,unused-ignore]
    content: str | JsArray[Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array__content__Union1__array] | Ai_Cf_Meta_Llama_4_Messages_Inner_iface__messages__array__content__Union2 | None = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__functions__array(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    code: str = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union0__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union0__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union0__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union0(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union0__parameters = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union1__function__parameters__properties(Protocol): # type:ignore[misc, unused-ignore]
    pass

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union1__function__parameters(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    required: JsArray[str] | None = ... # type:ignore[assignment,unused-ignore]
    properties: Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union1__function__parameters__properties = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union1__function(Protocol): # type:ignore[misc, unused-ignore]
    name: str = ... # type:ignore[assignment,unused-ignore]
    description: str = ... # type:ignore[assignment,unused-ignore]
    parameters: Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union1__function__parameters = ... # type:ignore[assignment,unused-ignore]

class Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union1(Protocol): # type:ignore[misc, unused-ignore]
    type: str = ... # type:ignore[assignment,unused-ignore]
    function: Ai_Cf_Meta_Llama_4_Messages_Inner_iface__tools__array__Union1__function = ... # type:ignore[assignment,unused-ignore]
